(function () {
  ...
  class GraphView extends View {
      ...
      initializeContent(data, rememberedSelection) {
          select("#layout").on("click", partial(this.layoutAction, this));
          select("#show-all").on("click", partial(this.showAllAction, this));
          select("#toggle-hide-dead").on("click", partial(this.toggleHideDead, this));
          select("#hide-unselected").on("click", partial(this.hideUnselectedAction, this));
          select("#hide-selected").on("click", partial(this.hideSelectedAction, this));
          select("#zoom-selection").on("click", partial(this.zoomSelectionAction, this));
          select("#toggle-types").on("click", partial(this.toggleTypesAction, this));
...
<div id="graph-toolbox">
  ...
  class GraphMultiView extends View {
      ...
      constructor(id, selectionBroker, sourceResolver) {
          ...
          this.selectMenu = toolbox.querySelector('#display-selector');
      }
      initializeSelect() {
          const view = this;
